...
var far = 2500;      // far clipping plane's distance
...
function render() {		
	...
	//Utilize the render pipeline for Mercury
	name = "Mercury";
	planet = Planets[name];
	data = SolarSystem[name];
	...
	ms.push();
	ms.rotate(data.year * time * orbitScalar, [0.0, 1.0, 0.0]);
	ms.translate(data.distance * distanceScalar, 0, 0);
	ms.scale(data.radius);
	gl.useProgram(planet.program);
	gl.uniformMatrix4fv(planet.uniforms.MV, false, flatten(ms.current()));
	gl.uniformMatrix4fv(planet.uniforms.P, false, flatten(P));
	...
	//Utilize the render pipeline for Venus
	name = "Venus";
	planet = Planets[name];
	data = SolarSystem[name];
	...
	ms.rotate(data.year * time * orbitScalar, [0.0, 1.0, 0.0]);
	ms.translate(data.distance * distanceScalar * 80, 0, 0);
	ms.scale(data.radius);
	gl.useProgram(planet.program);
	gl.uniformMatrix4fv(planet.uniforms.MV, false, flatten(ms.current()));
	gl.uniformMatrix4fv(planet.uniforms.P, false, flatten(P));
	...
	//Utilize the render pipeline for Mars
	name = "Mars";
	planet = Planets[name];
	data = SolarSystem[name];
	...
	//Utilize the render pipeline for Jupiter
	name = "Jupiter";
	planet = Planets[name];
	data = SolarSystem[name];
	...
	//Utilize the render pipeline for Saturn
	name = "Saturn";
	planet = Planets[name];
	data = SolarSystem[name];
	...
	//Utilize the render pipeline for Uranus
	name = "Uranus";
	planet = Planets[name];
	data = SolarSystem[name];
	...
	//Utilize the render pipeline for Neptune
	name = "Neptune";
	planet = Planets[name];
	data = SolarSystem[name];
	...
	//Utilize the render pipeline for Pluto
	name = "Pluto";
	planet = Planets[name];
	data = SolarSystem[name];
